...
var CypressTestRailReporter = /** @class */ (function (_super) {
    ...
    function CypressTestRailReporter(runner, options) {
        ...
        runner.on('start', function () {
            // Commenting this out so we do not create a new test run each time.
            ...
            // Dynamically get the open test run
            _this.testRail.getRun();
        });
        ...
        runner.on('end', function () {
            if (_this.results.length == 0) {
                ...
                // Comment this out so we do not accidentally delete the test run we created in TestRails
